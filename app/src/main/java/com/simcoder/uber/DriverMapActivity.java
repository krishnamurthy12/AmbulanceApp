            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    if(driverName==null && phoneNumber==null) {
                        ...
                        editor.putString("driverPhoneNumber", phoneNumber);
                    }
                    editor.apply();
                    ...
                    SharedPreferences driverPreferences=getSharedPreferences("DRIVERAVAILABLE_PREFERENCE",MODE_PRIVATE);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(DriverMapActivity.this, DriverLoginActivity.class));
                    finish();
                }
                else {
                    userId= user.getUid();
    ...
    private void getAssignedCustomer(){
        if(userId!=null)
        {
            ...
            DatabaseReference assignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers")
                    .child(userId).child("customerRequest").child("customerRideId");
        ...
        assignedCustomerPickupLocationRefListener = assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && !customerId.equals("")){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLatLng).title(getCompleteAddressString(locationLat,locationLng)).icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_pickup)));
